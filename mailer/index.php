...
try {
    ...
    $mail->Password = '7259124525Bilal';                           // SMTP password
...
'allow_self_signed' => true
   ...
   $mail1->isSMTP();                                      // Set mailer to use SMTP
    ...
    $mail1->Password = '7259124525Bilal';                           // SMTP password
...
'allow_self_signed' => true
    ...
    $email=$_GET['email'];
if($message!=NULL){
    $mail->setFrom('syedbilalhussain.sbh12@gmail.com', 'Quarter Coffee');
    ...
    $mail->Subject = 'Quarter Coffee';
    $mail->Body    = $body;
    $mail->AltBody =  strip_tags($body);
    $mail->send();

    $mail1->setFrom($email, 'Quarter Coffee');
    ...
    $body = '<p>A customer wants to contact us</p><p>Name : .'.$name.'</p><p>Email : '.$email.'</p><p><p>Message: '.$message.' </p>';
    ...
    $mail1->Subject = 'Quarter Coffee Contact US';
    $mail1->Body    = $body;
    ...
    $mail->setFrom($email, 'Request Alert');
    $mail->addAddress('syedbilalhussain.sbh12@gmail.com');     // Add a recipient
    // $mail->addAddress('ellen@example.com');               // Name is optional
    // $mail->addReplyTo('info@example.com', 'Information');
    // $mail->addCC('cc@example.com');
    // $mail->addBCC('bcc@example.com');

    $body = '<p><strong>hi '.$name.'</strong> wants to request you for sign up</p>';
    ...
    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Quarter Coffee Request';
    $mail->Body    = $body;
    $mail->AltBody =  strip_tags($body);
    $mail->send();
        $message="Thank your contacting us we will get back to you soon";
