	...
	<div class="container">
		<div class="row">
			...
			<div class="wow fadeInUp " data-wow-delay="0.9s">
				<h1 style="font-family: 'Montserrat', sans-serif;text-align: left;">Our Blogs</h1>
				<h4 style="text-align: left;font-family: 'Montserrat', sans-serif;">Coffee Shop > <span style="color:#c0aa83">Our Blogs</span></h4>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="wow fadeInUp col-md-12 col-sm-12" data-wow-delay="0.9s">
				<h2 style="font-family: 'Montserrat', sans-serif;">Coming Soon</h2>
			</div>
